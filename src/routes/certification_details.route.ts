...
import { addCertificationValidation, pageAndSizeQueryValidation, updateCertificationValidation } from "../utils/express_validator";
...
routes.get("/get", pageAndSizeQueryValidation,(req: Request, res: Response) => certificationDetailsController.getAllCertificationDetails(req, res));
