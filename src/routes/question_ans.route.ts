...
import { addQuestionAnsValidation, pageAndSizeQueryValidation } from "../utils/express_validator";
...
routes.get("/get", pageAndSizeQueryValidation, (req: Request, res: Response) => questionAnsController.getAllQuestionAns(req, res));
