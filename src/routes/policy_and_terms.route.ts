...
routes.put("/edit/:id",verifyAdminToken, updatePolicyAndTermsValidation, (req: any, res: any) => policyAndTermsController.updateData(req, res));
routes.get("/get/:id", (req: any, res: any) => policyAndTermsController.getData(req, res));
routes.get("/get", policyAndTermsQueryValidation, (req: Request, res: Response) => policyAndTermsController.getAllData(req, res));
routes.delete("/remove/:id",verifyAdminToken, (req: any, res: any) => policyAndTermsController.removeData(req, res));
